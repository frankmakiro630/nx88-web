...
if (file_exists('api.php')) {
    ...
    echo "<li>CLIENT_SECRET: "XeV1uKre72usVRYsHPF_52deiiRnr5Cb'YOUR_DISCORD_CLIENT_SECRET_HERE' ? 'CONFIGURED ✅' : 'NOT CONFIGURED ❌') . "</li>";
    echo "<li>REDIRECT_URI: "https://nx88-web.frankcute2603.workers.dev/auth/discord/callback'NOT FOUND') . "</li>";
    echo "</ul>";
